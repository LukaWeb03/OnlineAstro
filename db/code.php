...
function sendemail_verify($name,$email,$verify_token)
{
    ...
    $mail->isHTML(true);
    $mail->Subject = "OnlineAstro verification email";

    $email_template = "
        <h2>You have successfully registered on OnlineAstro</h2>
        <h3>Please verify your email address with given link</h3>
        <br/><br/>
        <a href='$domain_name/verify-email.php?token=$verify_token'> Verify email </a>
    ";
